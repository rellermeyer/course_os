...
#define P_KERNBASE		0x00008000
#define P_KERNTOP		0x00200000
//Physical location of kernel. Defined in the linker script.
//const uint32_t P_KERNBASE;
//const uint32_t P_KERNTOP;
...
#define TIMERBASE   BCM2836BASE + 0x40
