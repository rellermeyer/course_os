...
TEST_CREATE(test_timer_cb_called, {
    ...
    bcm2836_schedule_timer_once(test_callback_1, 100);
...
TEST_CREATE(test_timer_cancel, {
    ...
    TimerHandle const handle = bcm2836_schedule_timer_once(test_callback_1, 100);
...
TEST_CREATE(test_timer_periodic_cb_called, {
    ...
    TimerHandle const handle = bcm2836_schedule_timer_periodic(test_callback_1, 100);
...
TEST_CREATE(test_timer_order, {
    ...
    bcm2836_schedule_timer_once(test_callback_1, 100);
    bcm2836_schedule_timer_once(test_callback_2, 200);
